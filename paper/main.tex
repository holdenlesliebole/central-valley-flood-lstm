...
everywhere and still misses high-flow observations that sit above a displaced center,
so the fix has to be flow-conditional: recalibration by flow band, or a bias-aware
head. Whatever fixes coverage must then be re-scored against the 22--26\% CRPS gain it
could erode.
